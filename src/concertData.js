  ...
  ukr: [
    ...
    },
    {
      ...
      eventLink:
        'https://www.staatstheater-nuernberg.de/spielplan-24-25/galerie-ukraine/24-02-2025/2100',
      participants:
        'Світлана Михайленко (вибір поезії, переклад), Наталія Грабарська (мецо-сопрано, бандура), Наталка Тотовицька (скрипка), Олена Василенко (фортепіано), Ширін Худайбергенова (сопрано), Анна Бичкова (мецо-сопрано), Євген Петронеллі (баритон), Дем’ян Матушевський (бас-баритон)',
    ...
    },
    {
      ...
      eventLink: '',
      participants:
        'Світлана Михаленко (ведуча, вибір поезії), Олена Василенко (фортепіано)б Ширін Худайбергенова (сопрано), Анна Бичкова (мецо-сопрано), Євген Петронеллі (баритон)',
      details: '',
      eventbrite: '',
    },
  ],
