    ...
    <Box>
      ...
      >
        ...
        >
          ...
          In der folgenden Datenschutzerklärung möchten wir Sie darüber
          aufklären, welche Arten Ihrer personenbezogenen Daten (nachfolgend
          auch kurz als „Daten“ bezeichnet) wir zu welchen Zwecken und in
          welchem Umfang verarbeiten, wenn Sie unsere Seite besuchen. Die
          ...
          zusammenfassend bezeichnet als „Onlineangebot“). <br />
          Die hier aufgeführten Informationen stellen wir gemäß §16 des
          Datenschutzgesetzes der Evangelischen Kirche in Deutschland
          (nachfolgend DSG EKD) zur Verfügung.{' '}
          <Typography sx={{ fontWeight: 'bold', textAlign: 'center' }}>
          ...
          Sofern Sie um Ihre Zustimmung zu einer Datenverarbeitung gebeten
          werden (z. B. durch Betätigung einer Schaltfläche oder Ähnliches), ist
          die Rechtsgrundlage für die Datenverarbeitung Ihre Einwilligung gemäß
          ...
          Verantwortlichen für die Datenerhebung folgende Rechte zu: Werden Ihre
          ...
          Verarbeitung einlegen (Art. 17, 18 und 21 DSGVO). Wenn Sie in die
          Datenverarbeitung eingewilligt haben oder ein Vertrag zur
          ...
          die Stadt Nürnberg, ob die gesetzlichen Voraussetzungen hierfür
          erfüllt sind.{' '}
          <Typography sx={{ fontWeight: 'bold', textAlign: 'center' }}>
            4) Kontaktdaten der zuständigen Aufsichtsbehörde
          </Typography>{' '}
          Die unabhängige Aufsicht für die Einhaltung der
          Datenschutzbestimmungen auf dieser Webseite obliegt folgender Stelle:{' '}
          <br />
