...
const About = () => {
  return (
    <div className={s.Container}>
      ...
      української музики (і не тільки), бо ми хочемо, щоб вона лунала по всьому
      світу і слухач мав змогу почути її наживо, саме тому ми створили наш
      проєкт.
      <br />
      ...
      Під час концерту буде проводитись благодійний збір на ремонт Харківського
      університету мистецтв ім.І.П.Котляревського, який сильно постраждав під
      час війни.
      <br />
